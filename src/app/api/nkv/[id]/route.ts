...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error deleting NKV registration:', error)
    return NextResponse.json(
...
// Optional: PUT endpoint for updating NKV registration (for edit functionality)
export async function PUT(
  ...
  try {
    ...
    console.error('Error updating NKV registration:', error)
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    )
